...
public class Camion {
    ...
    public boolean subir(Carga carga) {
        ...
        if (carga != null) {
            ...
            if (estado == 1 && pesoTotal <= cargaMax) {
                cargas.add(carga);
                aux = true; //aviso que se agrego exitosamente la carga.
            }
        }
        return aux;
    }
    ...
    public String mostrarListado(){
        ...
        //StringBuilder optimiza uso de memoria en concatenacion de cadenas.
        //for each: una vuelta por cada elemento de la colacción.
